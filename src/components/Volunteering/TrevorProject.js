...
export default function TrevorProject() {
  return (
    <>
      <div className="w-full">
        ...
        <div className="bg-[#bfbdca] w-full rounded-lg z-10 shadow-md">
          <h2 className="py-5 text-base md:px-5 px-3 leading-8">Founded in 1998, The Trevor Project is a national
                      ...
                      change.” Donations can be made <a className="hover:text-[#725038] hover:underline text-inherit" href="https://give.thetrevorproject.org/give/63307/#!/donation/checkout" target="_blank" rel="noreferrer">here</a>.</h2>
        </div>
      </div>
    </>
  );
